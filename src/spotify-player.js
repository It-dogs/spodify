/* Spotify JS-SDK - v1.10.0-e2448b9 */ ! function e(t, n, r) {
    function o(a, i) {
        if (!n[a]) {
            if (!t[a]) {
    ...
    1: [function(e, t, n) {
        ...
        var r = e("tslib");
        r.__exportStar(e("./promise_resolver"), n), r.__exportStar(e("./user_agent"), n), r.__exportStar(e("./monotonic_now"), n), r.__exportStar(e("./microtask"), n)
    }, {
        "./microtask": 2,
        "./monotonic_now": 3,
        "./promise_resolver": 4,
    ...
    2: [function(e, t, n) {
        ...
        function r() {
            if ("undefined" == typeof Promise) return function(e) {
        ...
        Object.defineProperty(n, "__esModule", {
            value: !0
        }), n.queueTask = n.makeQueueMicrotaskShim = void 0, n.makeQueueMicrotaskShim = r, n.queueTask = "undefined" != typeof globalThis && "function" == typeof globalThis.queueMicrotask ? globalThis.queueMicrotask.bind(globalThis) : r()
    }, {}],
    3: [function(e, t, n) {
        "use strict";
        Object.defineProperty(n, "__esModule", {
    ...
    4: [function(e, t, n) {
        ...
        Object.defineProperty(n, "__esModule", {
            value: !0
        }), n.createPromiseResolver = void 0, n.createPromiseResolver = function() {
            var e, t;
            return {
    ...
    5: [function(e, t, n) {
        ...
        var r = e("tslib");
        r.__exportStar(e("./interpolate_ua"), n), r.__exportStar(e("./parse_ua"), n)
    }, {
        "./interpolate_ua": 6,
        "./parse_ua": 7,
        tslib: 8
    ...
    6: [function(e, t, n) {
        ...
        n.interpolateUA = function(e) {
            ...
            return e.replace(/\{\{([^}]+?)\}\}/g, (function(e, n) {
                return r = n, (o = t) && o.hasOwnProperty(r) ? t[n] : "";
                var r, o
            }))
        }
    }, {
    ...
    7: [function(e, t, n) {
        ...
        n.parseUA = function(e, t) {
            ...
            var _ = u.match(r),
                ...
                d = _ || p;
            "trident" === d[1] ? (d[1] = "ie", d[4] && (d[2] = d[4])) : "crios" === d[1] && (d[1] = "chrome"), "win" === (c = u.match(/ip(?:ad|od|hone)/) ? "ios" : null !== (n = (u.match(/(?:webos|android)/) || u.match(/mac|win|linux|cros/) || [])[0]) && void 0 !== n ? n : "other") && (c = "windows");
                ...
                ! function(n) {
                    ...
                    n = function(e, n) {
                        ...
                        if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) a = Reflect.decorate(e, t, n, r);
                            ...
                            for (var i = e.length - 1; i >= 0; i--)(o = e[i]) && (a = (s < 3 ? o(a) : s > 3 ? o(t, n, a) : o(t, n)) || a);
                        ...
                        var r = Array(e),
                            o = 0;
                        for (t = 0; t < n; t++)
                            for (var s = arguments[t], a = 0, i = s.length; a < i; a++, o++) r[o] = s[a];
                        return r
                    }, E = function(e, t, n) {
                    ...
                    }, e("__extends", n), e("__assign", r), e("__rest", o), e("__decorate", s), e("__param", a), e("__metadata", i), e("__awaiter", u), e("__generator", c), e("__exportStar", f), e("__createBinding", O), e("__values", l), e("__read", _), e("__spread", p), e("__spreadArrays", d), e("__spreadArray", E), e("__await", h), e("__asyncGenerator", y), e("__asyncDelegator", v), e("__asyncValues", g), e("__makeTemplateObject", m), e("__importStar", A), e("__importDefault", R), e("__classPrivateFieldGet", T), e("__classPrivateFieldSet", M)
                }))
            }).call(this)
    ...
    9: [function(e, t, n) {
        ...
        Object.defineProperty(n, "__esModule", {
            ...
            function(e) {
                e.ACCOUNT_ERROR = "account_error", e.AUTH_ERROR = "authentication_error", e.AUTOPLAY_FAILED = "autoplay_failed", e.PLAYBACK_ERROR = "playback_error", e.PLAYER_INIT_ERROR = "initialization_error", e.PLAYER_READY = "ready", e.PLAYER_NOT_READY = "not_ready", e.PLAYER_STATE_CHANGED = "player_state_changed"
    ...
    10: [function(e, t, n) {
        ...
        Object.defineProperty(n, "__esModule", {
            ...
            function(e) {
                e.INVALID_LISTENER = "INVALID_LISTENER", e.INVALID_WEBPLAYBACK = "INVALID_WEBPLAYBACK", e.NO_BODY = "NO_BODY", e.NO_EVENT = "NO_EVENT", e.INVALID_OAUTH = "INVALID_OAUTH", e.MISSING_IFRAME = "MISSING_IFRAME", e.AUTOPLAY_FAILED = "AUTOPLAY_FAILED"
            }(n.Errors || (n.Errors = {}))
    }, {}],
    11: [function(e, t, n) {
        "use strict";
        Object.defineProperty(n, "__esModule", {
            ...
            function(e) {
                e.SPOTIFY_MESSAGE = "SP_MESSAGE", e.ACCOUNT_ERROR = "ACCOUNT_ERROR", e.AUTH_ERROR = "AUTH_ERROR", e.CONNECT = "CONNECT", e.CONNECTED = "CONNECTED", e.CURRENT_STATE = "CURRENT_STATE", e.DISCONNECT = "DISCONNECT", e.EVENT = "EVENT", e.GET_CURRENT_STATE = "GET_CURRENT_STATE", e.GET_TOKEN = "GET_TOKEN", e.GET_VOLUME = "GET_VOLUME", e.INIT = "INIT", e.LOADED = "LOADED", e.NEXT_TRACK = "NEXT_TRACK", e.PAUSE = "PAUSE", e.PLAYBACK_ERROR = "PLAYBACK_ERROR", e.ACTIVATE_ELEMENT = "ACTIVATE_ELEMENT", e.ACTIVATE_ELEMENT_ERROR = "ACTIVATE_ELEMENT_ERROR", e.PLAYER_INIT_ERROR = "PLAYER_INIT_ERROR", e.PLAYER_READY = "PLAYER_READY", e.PLAYER_NOT_READY = "PLAYER_NOT_READY", e.PLAYER_STATE_CHANGED = "PLAYER_STATE_CHANGED", e.PREV_TRACK = "PREV_TRACK", e.RESUME = "RESUME", e.SEEK = "SEEK", e.SET_NAME = "SET_NAME", e.SET_VOLUME = "SET_VOLUME", e.TOGGLE_PLAY = "TOGGLE_PLAY", e.TOKEN = "TOKEN", e.VOLUME = "VOLUME", e.AUTOPLAY_FAILED = "AUTOPLAY_FAILED"
    ...
    13: [function(e, t, n) {
        ...
        function a() {
            if (!document.body) throw new o.PlayerError(r.Errors.NO_BODY, "Document doesn't have a body");
            if (window.Spotify = {
                    Player: s.setupPlayerEnv(window)
                }, window.onSpotifyWebPlaybackSDKReady) return window.onSpotifyWebPlaybackSDKReady();
        ...
        n.setupPlayerEnv = function(e, t) {
            var n = "https://sdk.scdn.co/embedded/index.html",
                ...
                p = t || function(t) {
                    ...
                    return n.src = t, n.setAttribute("alt", "Audio Playback Container"), n.setAttribute("tabIndex", "-1"), n.style.setProperty("position", "absolute", "important"), n.style.setProperty("left", "-1px", "important"), n.style.setProperty("width", "0", "important"), n.style.setProperty("height", "0", "important"), n.style.setProperty("border", "none", "important"), n.style.setProperty("outline", "none", "important"), n.allow = "encrypted-media; autoplay", e.document.body.appendChild(n), n.contentWindow
                };
            _.listen(e, (function(t) {
                t === s.Messages.LOADED && (_.stopListening(e), l.resolve())
            }));
            var d = p(n);
            return function() {
                function t(t) {
                    ...
                    }, this._handleMessages = this._handleMessages.bind(this), this._eventListeners = ((n = {})[a.AnthemEvents.ACCOUNT_ERROR] = [], n[a.AnthemEvents.AUTH_ERROR] = [], n[a.AnthemEvents.AUTOPLAY_FAILED] = [], n[a.AnthemEvents.PLAYBACK_ERROR] = [], n[a.AnthemEvents.PLAYER_INIT_ERROR] = [], n[a.AnthemEvents.PLAYER_READY] = [], n[a.AnthemEvents.PLAYER_NOT_READY] = [], n[a.AnthemEvents.PLAYER_STATE_CHANGED] = [], n), this._connectionRequests = {}, this._getCurrentStateRequests = {}, this._getVolumeRequests = {}, this._messageHandlers = ((r = {})[s.Messages.GET_TOKEN] = this._onGetToken.bind(this), r[s.Messages.EVENT] = this._onEvent.bind(this), r[s.Messages.CONNECTED] = this._onConnected.bind(this), r[s.Messages.CURRENT_STATE] = this._onCurrentState.bind(this), r[s.Messages.VOLUME] = this._onVolume.bind(this), r), this.isLoaded = l.promise.then((function() {
                        _.listen(e, u._handleMessages), u._sendMessage(f.messages.init(u._options))
                    }))
                }
                return t.prototype._getListeners = function(e) {
                    ...
                    if ("function" == typeof r) new Promise(r).then((function(e) {
                        n._sendMessage(f.messages.token(e, t))
                    }));
                    else {
                        if (!this._getListeners(a.AnthemEvents.PLAYER_INIT_ERROR).length) throw new u.PlayerError(i.Errors.INVALID_OAUTH, "getOAuthToken is not a function");
                        this._onEvent({
                    ...
                    var t;
                    e.ref in this._connectionRequests && (null === (t = this._connectionRequests[e.ref]) || void 0 === t || t.resolve(e.connected), delete this._connectionRequests[e.ref])
                }, t.prototype._onCurrentState = function(e) {
                    var t;
                    e.ref in this._getCurrentStateRequests && (null === (t = this._getCurrentStateRequests[e.ref]) || void 0 === t || t.resolve(e.state), delete this._getCurrentStateRequests[e.ref])
                }, t.prototype._onVolume = function(e) {
                    var t;
                    e.ref in this._getVolumeRequests && (null === (t = this._getVolumeRequests[e.ref]) || void 0 === t || t.resolve(e.volume), delete this._getVolumeRequests[e.ref])
                    ...
                    return this.isLoaded.then((function() {
                        ...
                        return e._connectionRequests[n] = o.createPromiseResolver(), null === (t = e._connectionRequests[n]) || void 0 === t ? void 0 : t.promise
                    }))
                }, t.prototype.on = function(e, t) {
                    return -1 === this._eventListeners[e].indexOf(t) && (this._eventListeners[e].push(t), !0)
                }, t.prototype.addListener = function(e, t) {
                    return this.on(e, t)
                }, t.prototype.removeListener = function(e, t) {
                    var n = this._eventListeners[e];
                    return 1 === arguments.length ? (this._eventListeners[e] = [], !0) : !(!n || !n.length) && (this._eventListeners[e] = n.filter((function(e) {
                        return e !== t
                    })), !0)
                    ...
                    return this.isLoaded.then((function() {
                        ...
                        return e._getCurrentStateRequests[n] = o.createPromiseResolver(), null === (t = e._getCurrentStateRequests[n]) || void 0 === t ? void 0 : t.promise
                    }))
                }, t.prototype.getVolume = function() {
                    var e = this;
                    return this.isLoaded.then((function() {
                        var t, n = e._sendMessage(f.messages.getVolume());
                        return e._getVolumeRequests[n] = o.createPromiseResolver(), null === (t = e._getVolumeRequests[n]) || void 0 === t ? void 0 : t.promise
                    }))
